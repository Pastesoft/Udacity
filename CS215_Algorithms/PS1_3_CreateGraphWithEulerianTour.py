...
# to create the Eulerian tour I added
# every a couple with a node n coupled with the following one (n+1)
# then I linked the first and the last node to make the Eulerian path
